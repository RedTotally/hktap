...
export default function Home() {
  ...
  useGSAP(
    () => {
      ...
      const whyText = q("[data-animate='why-text']")[0] as
        | HTMLElement
        | undefined;
      if (whyText) {
      ...
      const whyVideo = q("[data-animate='why-video']")[0] as
        | HTMLElement
        | undefined;
      if (whyVideo) {
        gsap.fromTo(
        ...
        <div ref={pageRef}>
          ...
          <div>
            <div className="sticky bg-white top-0 z-[99] py-15 animate-fade-up animate-ease-in-out px-10">
              ...
              <p data-animate="pop" className="text-center mt-3 text-gray-600">
                A few taps, know where to go on the map; find extraordinary
                places in Hong Kong.
              </p>
            </div>
            ...
            <div className="p-4 col-span-3">
              ...
              >
                ...
                <p
                  ...
                  data-sketch-child
                >
                  Our advanced camera feature automatically records your
                  location when you submit, so you don't have to manually input
                  where you are. 3, 2, 1... Captured! Share your location
            ...
            <div className="p-4 col-span-3">
              ...
              >
                ...
                <p
                  ...
                  data-sketch-child
                >
                  We want everyone to participate in this craze. Show your love
                  to the locations you are deeply interested in. Show the world
                  what you love in Hong Kong by heating them up!
                </p>
              </div>
            </div>
            ...
            <div className="p-4 col-span-4">
              ...
              >
                ...
                >
                  ...
                  advanced model and fresh data, you are promised to get the
            ...
            <div className="p-4 col-span-1">
              ...
              >
                ...
                >
                  ...
                  destinations: more warm, welcoming, and straightforward; we
                  have the right place for you.
                </p>
              </div>
            </div>
            <div className="p-4 col-span-1">
              ...
              >
                ...
                >
                  ...
                  exceptional. It is a place that stands up to any adversity;
                  When we face troubles, we find solutions. Enthusiasm,
                  solidarity, and thoughtfulness made us unique and magical. We
                  love it here!
                </p>
              </div>
            </div>
          ...
          <div className="relative z-[50] px-10 2xl:px-20 mt-[20em]">
            <div className="lg:flex justify-between items-center">
              ...
              <div className="flex justify-center rounded-xl ml-0 lg:ml-10">
                <video
          ...
          <div data-animate="team-section" className="mt-[20em] px-3 md:px-10">
            <div
              data-animate="team-header"
              className="flex justify-center items-center mb-5"
            >
            ...
            <div className="grid md:grid-cols-2 2xl:grid-cols-4 gap-5 md:px-10 2xl:px-20 mt-20">
              ...
              >
                ...
                <p className="mt-10 text-xs">
                  "Heaven definitely creates us for a purpose. Heads down on
                  best creations, riches will return in season."—Jeff Leung
                </p>
              </div>
